 ...
 * animierter Scrollytelling-Seite (ProjektPage.tsx) — dieselben echten
 * Texte, ohne die SVG-Illustrationen/Scroll-Reveals, die auf einem
 * Telefon nur Gewicht ohne Mehrwert wären.
 */
...
export default function MobileProjekt() {
  ...
  return (
    <MobileScreenShell C={C} title="Projekt" meta="DIE MECHANIK">
      ...
      <div style={{ fontFamily: SERIF, fontStyle: "italic", fontSize: 15, lineHeight: 1.6, color: C.textDim, marginBottom: 22 }}>
      ...
      <div style={{ fontFamily: SERIF_BODY, fontSize: 14.5, lineHeight: 1.72, color: C.textDim }}>
        {[
          { kicker: "Die Idee", title: "Erkenntnis im Zwischen", body: (
            <>
          ...
          { kicker: "Der Kreislauf", title: "Ein Werk, das aus Begegnungen lernt", body: (
            <>
          ...
          { kicker: "Die Mechanik", title: "Live anhängen, vollständig nachrechnen", body: (
